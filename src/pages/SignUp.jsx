    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      >
        ...
        <div className="dark-card p-8">
          <h1 className="font-heading text-2xl font-semibold text-white text-center tracking-tight">Create account</h1>
          ...
          <p className="mt-6 text-center text-sm text-text-secondary">
            ...
            <Link to="/login" className="text-primary hover:text-primary-light transition-colors duration-300">
              Sign in
            </Link>
          </p>
        </div>
